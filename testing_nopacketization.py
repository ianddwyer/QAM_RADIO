...
class testing_nopacketization(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "testing_nopacketization", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("testing_nopacketization")
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "testing_nopacketization")
        ...
        self.txgain = txgain = 42
        self.shift = shift = samp_rate/4
        self.rxgain = rxgain = 7
        ...
        self._txgain_range = qtgui.Range(0, 60, 1, 42, 8)
        ...
        for c in range(1, 2):
            self.top_grid_layout.setColumnStretch(c, 1)
        self._rxgain_range = qtgui.Range(7, 40, 1, 7, 8)
        ...
        self.qtgui_time_sink_x_2.set_y_axis(-127, 127)
        ...
        for c in range(0, 1):
            self.top_grid_layout.setColumnStretch(c, 1)
        self.mmse_resampler_xx_2_0 = filter.mmse_resampler_ff(0, ( (samp_rate/samp_per_sym/8*C.bits_per_symbol())/device_rate))
        ...
        self.connect((self.blocks_multiply_const_xx_0, 0), (self.digital_symbol_sync_xx_0_0, 0))
        self.connect((self.blocks_multiply_const_xx_0, 0), (self.qtgui_freq_sink_x_0_1, 0))
        self.connect((self.blocks_packed_to_unpacked_xx_0_0_0, 0), (self.blocks_stream_to_tagged_stream_0, 0))
        self.connect((self.blocks_repack_bits_bb_1_0, 0), (self.blocks_char_to_float_0_0, 0))
        self.connect((self.blocks_stream_to_tagged_stream_0, 0), (self.blocks_repack_bits_bb_1_0, 0))
        ...
        self.connect((self.blocks_unpacked_to_packed_xx_0, 0), (self.blocks_packed_to_unpacked_xx_0_0_0, 0))
        self.connect((self.blocks_wavfile_source_0, 0), (self.blocks_probe_rate_1, 0))
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.mmse_resampler_xx_2_0.set_resamp_ratio(( (self.samp_rate/self.samp_per_sym/8*C.bits_per_symbol())/self.device_rate))
    ...
    def set_device_rate(self, device_rate):
        ...
        self.mmse_resampler_xx_2.set_resamp_ratio((self.device_rate/ (self.samp_rate/self.samp_per_sym/8*C.bits_per_symbol())))
        self.mmse_resampler_xx_2_0.set_resamp_ratio(( (self.samp_rate/self.samp_per_sym/8*C.bits_per_symbol())/self.device_rate))
        self.qtgui_time_sink_x_2.set_samp_rate(self.device_rate)
...
def main(top_block_cls=testing_nopacketization, options=None):
