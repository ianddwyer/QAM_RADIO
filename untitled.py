...
class untitled(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.device_rate = device_rate = 100e3
        self.delay = delay = 0
        ...
        self.network_udp_source_1_0 = network.udp_source(gr.sizeof_char, 1, 5006, 0, 1024, True, True, False)
        self.network_udp_source_1_0.set_max_output_buffer(int(2e6))
        self.network_udp_sink_0 = network.udp_sink(gr.sizeof_char, 1, '127.0.0.1', 5007, 0, 1024, False)
        self._delay_range = qtgui.Range(0, 100, 1, 0, 200)
        self._delay_win = qtgui.RangeWidget(self._delay_range, self.set_delay, "delay", "counter", int, QtCore.Qt.Horizontal)
        self.top_layout.addWidget(self._delay_win)
        self.blocks_throttle2_0 = blocks.throttle( gr.sizeof_float*1, (device_rate*2*4), True, 0 if "auto" == "auto" else max( int(float(0.1) * (device_rate*2*4)) if "auto" == "time" else int(0.1), 1) )
        ...
        self.connect((self.blocks_char_to_float_0_0, 0), (self.blocks_throttle2_0, 0))
        self.connect((self.blocks_float_to_char_0, 0), (self.blocks_char_to_float_0, 0))
        self.connect((self.blocks_float_to_char_0_0, 0), (self.network_udp_sink_0, 0))
        self.connect((self.blocks_throttle2_0, 0), (self.rational_resampler_xxx_0, 0))
        self.connect((self.network_udp_source_1_0, 0), (self.blocks_char_to_float_0_0, 0))
        self.connect((self.network_udp_source_1_0, 0), (self.blocks_probe_rate_1, 0))
        ...
        self.connect((self.rational_resampler_xxx_1, 0), (self.blocks_float_to_char_0_0, 0))
    ...
    def set_device_rate(self, device_rate):
        ...
        self.blocks_throttle2_0.set_sample_rate((self.device_rate*2*4))
