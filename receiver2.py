...
def udp_listener():
    ...
    while True:
        ...
        except queue.Full: continue #print("Queue full — dropping frame.")
        except Exception as e: continue #print("Listener error:", e)
...
def audio_callback(outdata, frames, time_info, status):
    ...
    except queue.Empty: outdata.fill(0) #"Queue empty — inserting silence."
