...
import QAMattempt_epy_block_0 as epy_block_0  # embedded python block
import QAMattempt_epy_block_0_0 as epy_block_0_0  # embedded python block
...
class QAMattempt(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "QAMattempt")
        ...
        # Variables
        ##################################################
        self.samp_rate = samp_rate = 6.144e6//2
        ...
        self.packet_len = packet_len = 1024-12
        self.exbw = exbw = 1.0
        ...
        self.rrc_taps = rrc_taps = firdes.root_raised_cosine(128, 128, 1.0/float(samp_per_sym), exbw, 11*samp_per_sym*128)
        ...
        self.psk4.set_npwr(1.0)
        self.psk2 = psk2 = digital.constellation_calcdist(np.array([-1, 1]), [0, 1],
        4, 1, digital.constellation.NO_NORMALIZATION).base()
        self.psk2.set_npwr(1.0)
        self.ppm = ppm = 0.3
        self.port = port = 5005
        self.num = num = Fraction(channels*BInf32*device_rate/ (samp_rate/samp_per_sym/8*C.bits_per_symbol()*packet_len/(packet_len+12))).limit_denominator(1000).numerator
        self.next_episode = next_episode = "music/Dr._Dre_-_The_Next_Episode_Wooli_Flip.wav"
        self.music = music = 1
        self.message = message = 0
        self.hunter = hunter = "music/Subtronics x Flowdan - Hunter.wav"
        self.hdr_format = hdr_format = digital.header_format_default(access_key, 0)
        self.final_breath = final_breath = "Final+Breath.wav"
        self.den = den = Fraction(channels*BInf32*device_rate/ (samp_rate/samp_per_sym/8*C.bits_per_symbol()*packet_len/(packet_len+12))).limit_denominator(1000).denominator
        self.centerf = centerf = 0.915e9
        self.bandwidth = bandwidth = symbol_rate*(1+exbw)
        self.aa = aa = digital.adaptive_algorithm_cma( C, 0.0008, C.arity()).base()
        ...
        self._txgain_range = qtgui.Range(0, 70, 1, 70, 8)
        ...
        self._rxgain_range = qtgui.Range(4, 50, 1, 15, 8)
        ...
        self.uhd_usrp_source_0.set_center_freq(uhd.tune_request(centerf, shift), 0)
        self.uhd_usrp_source_0.set_antenna("RX2", 0)
        self.uhd_usrp_source_0.set_gain(rxgain, 0)
        self.uhd_usrp_source_0.set_max_output_buffer((2**16))
        ...
        self.uhd_usrp_sink_0.set_max_output_buffer((2**16))
        ...
        self.rational_resampler_xxx_0 = filter.rational_resampler_fff(
                ...
                taps=[],
                fractional_bw=0)
        self.rational_resampler_xxx_0.set_max_output_buffer((2**16))
        self.qtgui_time_sink_x_1 = qtgui.time_sink_f(
            1024, #size
            device_rate, #samp_rate
            "", #name
            1, #number of inputs
            None # parent
        )
        ...
        self.qtgui_freq_sink_x_0_1.set_y_axis((-90), (-20))
        ...
        self.packetread_0.set_max_output_buffer((2**16))
        self.packetgen_0 = packetgen(
            access_key=access_key,
            packet_len=packet_len,
            packet_len_tagn="packet_len",
        )
        self.packetgen_0.set_max_output_buffer((2**16))
        self.mmse_resampler_xx_0_0 = filter.mmse_resampler_ff(0, (device_rate/48000))
        self.mmse_resampler_xx_0 = filter.mmse_resampler_ff(0, (device_rate/48000))
        self.epy_block_7 = epy_block_7.blk(timeout=0.1)
        self.epy_block_7.set_max_output_buffer((2**16))
        self.epy_block_5 = epy_block_5.blk(byte_order="little")
        self.epy_block_5.set_max_output_buffer((2**16))
        self.epy_block_4 = epy_block_4.blk(byte_order="little")
        self.epy_block_4.set_max_output_buffer((2**16))
        ...
        self.digital_symbol_sync_xx_0_0 = digital.symbol_sync_cc(
            ...
            128,
            rrc_taps)
        self.digital_symbol_sync_xx_0_0.set_max_output_buffer((2**16))
        self.digital_linear_equalizer_0 = digital.linear_equalizer(1, 1, aa, True, [ ], 'corr_est')
        self.digital_linear_equalizer_0.set_max_output_buffer((2**16))
        ...
        self.digital_constellation_receiver_cb_0_0.set_max_output_buffer((2**16))
        self.digital_constellation_modulator_0 = digital.generic_mod(
            ...
            log=False,
            truncate=False)
        self.digital_constellation_modulator_0.set_max_output_buffer((2**16))
        self.blocks_wavfile_source_0 = blocks.wavfile_source(next_episode, True)
        self.blocks_wavfile_source_0.set_min_output_buffer((2**16//2))
        self.blocks_wavfile_source_0.set_max_output_buffer((2**16))
        self.blocks_unpacked_to_packed_xx_0 = blocks.unpacked_to_packed_bb(C.bits_per_symbol(), gr.GR_MSB_FIRST)
        self.blocks_throttle2_1 = blocks.throttle( gr.sizeof_float*1, (device_rate*2), True, 0 if "auto" == "auto" else max( int(float(0.1) * (device_rate*2)) if "auto" == "time" else int(0.1), 1) )
        ...
        self.analog_agc_xx_0 = analog.agc_cc(0.00003, 0.84, 1, 65536)
        self.analog_agc_xx_0.set_max_output_buffer((2**16))
        ...
        self.connect((self.analog_agc_xx_0, 0), (self.digital_symbol_sync_xx_0_0, 0))
        ...
        self.connect((self.blocks_deinterleave_0, 0), (self.mmse_resampler_xx_0, 0))
        self.connect((self.blocks_deinterleave_0, 1), (self.mmse_resampler_xx_0_0, 0))
        self.connect((self.blocks_deinterleave_0, 0), (self.qtgui_time_sink_x_1, 0))
        self.connect((self.blocks_interleave_0, 0), (self.rational_resampler_xxx_0, 0))
        self.connect((self.blocks_multiply_const_vxx_1, 0), (self.blocks_probe_rate_1, 0))
        ...
        self.connect((self.blocks_throttle2_1, 0), (self.blocks_deinterleave_0, 0))
        self.connect((self.blocks_unpacked_to_packed_xx_0, 0), (self.packetread_0, 0))
        self.connect((self.blocks_wavfile_source_0, 0), (self.blocks_interleave_0, 0))
        self.connect((self.blocks_wavfile_source_0, 1), (self.blocks_interleave_0, 1))
        ...
        self.connect((self.digital_linear_equalizer_0, 0), (self.analog_agc_xx_0, 0))
        ...
        self.connect((self.epy_block_4, 0), (self.packetgen_0, 0))
        self.connect((self.epy_block_5, 0), (self.rational_resampler_xxx_0_0, 0))
        self.connect((self.epy_block_7, 0), (self.blocks_null_sink_1_0, 0))
        self.connect((self.mmse_resampler_xx_0, 0), (self.audio_sink_0, 0))
        self.connect((self.mmse_resampler_xx_0_0, 0), (self.audio_sink_0, 1))
        ...
        self.connect((self.packetread_0, 0), (self.epy_block_5, 0))
        self.connect((self.packetread_0, 0), (self.epy_block_7, 0))
        self.connect((self.rational_resampler_xxx_0, 0), (self.epy_block_4, 0))
        self.connect((self.rational_resampler_xxx_0_0, 0), (self.blocks_multiply_const_vxx_1, 0))
        self.connect((self.uhd_usrp_source_0, 0), (self.digital_linear_equalizer_0, 0))
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.set_den(Fraction(self.channels*self.BInf32*self.device_rate/ (self.samp_rate/self.samp_per_sym/8*C.bits_per_symbol()*self.packet_len/(self.packet_len+12))).limit_denominator(1000).denominator)
        self.set_num(Fraction(self.channels*self.BInf32*self.device_rate/ (self.samp_rate/self.samp_per_sym/8*C.bits_per_symbol()*self.packet_len/(self.packet_len+12))).limit_denominator(1000).numerator)
    ...
    def set_samp_per_sym(self, samp_per_sym):
        ...
        self.set_den(Fraction(self.channels*self.BInf32*self.device_rate/ (self.samp_rate/self.samp_per_sym/8*C.bits_per_symbol()*self.packet_len/(self.packet_len+12))).limit_denominator(1000).denominator)
        self.set_num(Fraction(self.channels*self.BInf32*self.device_rate/ (self.samp_rate/self.samp_per_sym/8*C.bits_per_symbol()*self.packet_len/(self.packet_len+12))).limit_denominator(1000).numerator)
        self.set_rrc_taps(firdes.root_raised_cosine(128, 128, 1.0/float(self.samp_per_sym), self.exbw, 11*self.samp_per_sym*128))
    ...
    def set_device_rate(self, device_rate):
        ...
        self.set_den(Fraction(self.channels*self.BInf32*self.device_rate/ (self.samp_rate/self.samp_per_sym/8*C.bits_per_symbol()*self.packet_len/(self.packet_len+12))).limit_denominator(1000).denominator)
        self.set_num(Fraction(self.channels*self.BInf32*self.device_rate/ (self.samp_rate/self.samp_per_sym/8*C.bits_per_symbol()*self.packet_len/(self.packet_len+12))).limit_denominator(1000).numerator)
        self.blocks_throttle2_1.set_sample_rate((self.device_rate*2))
        self.mmse_resampler_xx_0.set_resamp_ratio((self.device_rate/48000))
        self.mmse_resampler_xx_0_0.set_resamp_ratio((self.device_rate/48000))
        self.qtgui_time_sink_x_1.set_samp_rate(self.device_rate)
    ...
    def set_shift(self, shift):
        self.shift = shift
        self.uhd_usrp_source_0.set_center_freq(uhd.tune_request(self.centerf, self.shift), 0)
